  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white fixed top-0 left-0 h-screen border-r border-gray-100 z-40 font-nunito">
        ...
        {/* Nav */}
        <nav className="flex-1 px-3 pt-3 overflow-y-auto space-y-0.5 pb-2">
          {/* Inicio */}
          <Link
            ...
            hijos.map((hijo, idx) => {
              ...
              return (
                <div key={hijo.id}>
                  ...
                  <button
                    onClick={() =>
                      setHijoExpandido(estaExpandido ? null : hijo.id)
                    }
          ...
          {/* Agregar hijo si ya tiene hijos */}
          {hijos.length > 0 && (
            <Link
              href="/dashboard/padre/agregar-hijo"
          ...
          <div className="flex items-center justify-around">
            ...
            {hijos.length > 0 ? (
              <Link
                ...
                className={`flex flex-col items-center gap-1 px-3 py-1 rounded-xl transition-all ${pathname.includes("/hijo/") ? "text-orange-500" : "text-gray-300"}`}
              >
                <div
                  className={`p-1 rounded-xl overflow-hidden ${pathname.includes("/hijo/") ? "ring-2 ring-orange-400" : ""}`}
                >
                  {hijos[0].foto_url ? (
                    <img
                ...
                <span className="text-[10px] font-bold">{hijos[0].nombre}</span>
              </Link>
            ) : (
              <Link
                href="/dashboard/padre/agregar-hijo"
                className="flex flex-col items-center gap-1 px-3 py-1 rounded-xl text-gray-300"
              >
            ...
            {hijos.length > 0 && (
              <Link
                ...
                className={`flex flex-col items-center gap-1 px-3 py-1 rounded-xl transition-all ${pathname.includes("/bitacora") ? "text-orange-500" : "text-gray-300"}`}
              >
                <div
