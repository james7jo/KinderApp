...
import { Home, Baby, Bell, MapPin, LogOut } from "lucide-react";

const navItems = [
  { href: "/dashboard/padre", label: "Inicio", icon: Home },
  { href: "/dashboard/padre/agregar-hijo", label: "Mis Hijos", icon: Baby },
  { href: "/dashboard/padre/avisos", label: "Avisos", icon: Bell },
];
