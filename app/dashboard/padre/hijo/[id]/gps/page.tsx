...
export default function AlertasRecogidaPage() {
  ...
  // Realtime — llega notificación nueva al instante
  useEffect(() => {
    const channel = supabase
      .channel("notifs-padre-" + id)
      .on(
        "postgres_changes",
        {
          event: "INSERT",
        ...
        () => {
          setNueva(true);
          cargar();
          setTimeout(() => setNueva(false), 5000);
        },
      )
      .subscribe();
    return () => {
  ...
  return (
    <main className="min-w-0 font-nunito">
      ...
      <div className="px-4 lg:px-7 pt-5 pb-8 max-w-2xl mx-auto space-y-4">
        {notifs.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 py-16 text-center px-4">
            ...
            <p className="text-gray-400 text-sm">
              Cuando alguien recoja a tu hijo, te aparecerá aquí al instante
            </p>
          </div>
        ) : (
          notifs.map((n) => {
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-[10px] text-gray-400 font-bold">
                        {new Date(n.recogido_at).toLocaleDateString("es-BO", {
                          day: "numeric",
                          month: "short",
                          year: "numeric",
                        })}
                    ...
                    <div className="flex items-center gap-3 mt-2 flex-wrap">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs font-bold text-orange-500">
                          {new Date(n.recogido_at).toLocaleTimeString("es-BO", {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </span>
